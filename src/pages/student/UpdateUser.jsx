...
import { getStudentProfile, updateStudentProfile, getUser, saveUser } from "@/lib/api"
...
export default function UpdateStudentProfile() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      saveUser({ ...getUser(), student: res.data })
  ...
  if (!form || role !== "STUDENT") return <p className="p-6">Access denied or loading...</p>
  ...
  const formFields = [
    ...
    { name: "rollNumber", label: "Roll Number", type: "text", placeholder: "Enter your roll number" },
    { name: "yearOfStudy", label: "Year of Study", type: "text", placeholder: "Enter your year of study" },
    { name: "section", label: "Section", type: "text", placeholder: "Enter your section" },
    { name: "college", label: "College", type: "text", placeholder: "Enter your college name" },
    { name: "gender", label: "Gender", type: "text", placeholder: "Enter your gender" },
  ]
  ...
  return (
    <div className="p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">Keep your personal information up to date</p>
      </div>
